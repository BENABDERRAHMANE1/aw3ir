window.onload = function () {
    ...
    document.querySelector("form").addEventListener("submit", function (event) {
      ...
      if (document.getElementById("nom").value.length < 5) {
        ...
        document.querySelector(".modal-title").textContent = "Erreur"
        document.querySelector(".modal-body").innerHTML = "WOW! Vous êtes né(e) dans le futur.";
        myModal.show();
  
      }
      else {
        console.log('OK');
        document.querySelector(".modal-title").textContent = " Bienvenus " + document.getElementById("prenom").value + " " + document.getElementById("nom").value +" .";
        document.querySelector(".modal-body").innerHTML = "Vous  êtes ajouté(e)  à  la liste de nos contacts.";
